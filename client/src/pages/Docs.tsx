            ...
            <section>
                ...
                <ol className="border border-black divide-y divide-black">
                    {[
                        ...
                        ['Sign Upload', 'After extracting blobId from the transaction receipt, the browser signs: Mblob upload authorization / Blob ID / Nonce, then sends multipart form-data with the cached file bytes and signature headers to the gateway.'],
